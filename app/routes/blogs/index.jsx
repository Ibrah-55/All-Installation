...
function Posts() {
  let posts = useLoaderData();
    return (
       ...
       <div class="grid grid-cols-3 text-red-700 ">
            <div>Library</div>
  <div>Status</div>
  <div>Level</div>
</div>
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <div>
                                                <div class="text-blue-400 "> { posts.map(post => (
                    <div className="postList " key={post.slug}>
                        <Link className="postTitle" to={post.slug}>{Object.keys(post.Title[1])} </Link>
                                ...
                                <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <div class="text-sm font-normal text-emerald-500">Active</div>
                                    </div>
                                </td>
